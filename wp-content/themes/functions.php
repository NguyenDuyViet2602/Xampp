<?php
	...
	load_theme_textdomain( 'theme1545', TEMPLATEPATH . '/languages' );
     ...
     <div id="comment-<?php comment_ID(); ?>">
      <div class="comment-body">
      		...
      		<div class="extra-wrap">
      			...
      			<?php comment_text() ?>
      			<div class="reply">
      					<?php printf(__('<time>%1$s</time> <span class="author">%2$s</span>' ), get_comment_date('F j, Y'), get_comment_author_link()) ?>
